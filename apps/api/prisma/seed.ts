...
async function main() {
  ...
  const legalPages = [
    ...
    },
    {
      ...
      title: 'Contato',
      content:
        '<h2>Nossos Dados</h2><ul><li><strong>Razão Social:</strong> Saldão da Reserva Comércio Eletrônico Ltda.</li><li><strong>CNPJ:</strong> 00.000.000/0001-00</li><li><strong>E-mail:</strong> contato@saldaodareserva.com.br</li></ul><h2>Horário</h2><ul><li>Segunda a Sexta: 8h às 20h</li><li>Sábado: 9h às 15h</li></ul><p><em>Conteúdo editável pelo administrador.</em></p>',
      published: true,
    },
  ];
